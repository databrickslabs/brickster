...
|----|----|----|----|
| Upload file | Single file | [`db_volume_write()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_write.md) | Upload one local file to a volume path |
| Download file | Single file | [`db_volume_read()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_read.md) | Download one volume file to local disk |
| Delete file | Single file | [`db_volume_delete()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_delete.md) | Remove one file from a volume |
| Check file exists | Single file | [`db_volume_file_exists()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_file_exists.md) | Returns `TRUE`/`FALSE` |
| List contents | Directory | [`db_volume_list()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_list.md) | Lists files/subdirectories for a directory |
| Create directory | Directory | [`db_volume_dir_create()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_dir_create.md) | Creates target directory path |
| Check directory exists | Directory | [`db_volume_dir_exists()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_dir_exists.md) | Returns `TRUE`/`FALSE` |
| Delete directory | Directory | [`db_volume_dir_delete()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_dir_delete.md) | Use `recursive = TRUE` for non-empty directories |
| Upload directory | Bulk transfer | [`db_volume_upload_dir()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_upload_dir.md) | Parallel upload, `recursive = TRUE` includes subdirectories |
| Download directory | Bulk transfer | [`db_volume_download_dir()`](https://databrickslabs.github.io/brickster/dev/reference/db_volume_download_dir.md) | Parallel download, `recursive = TRUE` includes subdirectories |
...
| Delete volume | [`db_uc_volumes_delete()`](https://databrickslabs.github.io/brickster/dev/reference/db_uc_volumes_delete.md) | Removes the Unity Catalog volume object |
