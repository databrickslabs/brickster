...
| Function | Purpose |
|---:|----|
| [`db_cluster_runtime_versions()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_runtime_versions.md) | List of runtime versions available for the workspace, useful for finding relevant `spark_version` |
| [`db_cluster_list_node_types()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_list_node_types.md) | List of supported node types available in workspace/region, useful for finding relevant `node_type_id`/`driver_node_type_id` |
| [`db_cluster_list_zones()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_list_zones.md) | AWS Only, lists availability zones (AZ) clusters can occupy |
...
| Function | Purpose |
|---:|----|
| [`db_cluster_start()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_start.md) | Start a cluster that is inactive |
| [`db_cluster_restart()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_restart.md) | Restart a cluster, cluster must already be running |
| [`db_cluster_delete()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_delete.md) /[`db_cluster_terminate()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_terminate.md) | Terminate an active cluster, does not remove the cluster configuration from Databricks |
| [`db_cluster_perm_delete()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_perm_delete.md) | Stops (if active) and permanently deletes a cluster, it will not longer appear in Databricks |
...
|---:|----|
| [`lib_cran()`](https://databrickslabs.github.io/brickster/dev/reference/lib_cran.md) | CRAN |
| [`lib_pypi()`](https://databrickslabs.github.io/brickster/dev/reference/lib_pypi.md) | PyPi |
| [`lib_egg()`](https://databrickslabs.github.io/brickster/dev/reference/lib_egg.md) | Python egg (file) |
| [`lib_whl()`](https://databrickslabs.github.io/brickster/dev/reference/lib_whl.md) | Python wheel (file) |
| [`lib_maven()`](https://databrickslabs.github.io/brickster/dev/reference/lib_maven.md) | Maven |
| [`lib_jar()`](https://databrickslabs.github.io/brickster/dev/reference/lib_jar.md) | JAR (file) |
...
(e.g. [`db_cluster_restart()`](https://databrickslabs.github.io/brickster/dev/reference/db_cluster_restart.md)).
